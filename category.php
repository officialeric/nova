                    ...
                    <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="content-block post-list-view mt--30">
                            ...
                            <div class="post-content">
                                ...
                                <h4 class="title"><a href="post-details.html">Security isn’t just a technology problem it’s about design, too</a></h4>
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="content">
                                            <h6 class="post-author-name">
                    ...
                    <div class="col-lg-4 col-xl-4 mt_md--40 mt_sm--40">
                        ...
                        <div class="sidebar-inner">
                            ...
                            <div class="axil-single-widget widget widget_categories mb--30">
                                <ul>
                                    <li class="cat-item">
                                        <a href="archive.html#" class="inner">
                                            <div class="thumbnail">
                            ...
                            <div class="axil-single-widget widget widget_social mb--30">
                                ...
                                <ul class="social-icon md-size justify-content-center">
                                    ...
                                    <li><a href="archive.html#"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="archive.html#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="archive.html#"><i class="fab fa-slack"></i></a></li>
                                    <li><a href="archive.html#"><i class="fab fa-linkedin-in"></i></a></li>
                                </ul>
                                <!-- End Post List  -->
                            </div>
                            <!-- End Single Widget  -->
