                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    <input type="text" name="title" class="form-control" id="inputGroupFile04"
                                        ...
                                        placeholder='Post Title..' value='<?=$edited_post['title'] ?? null?>'>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-4">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">Xnova Editor</h4>
            ...
            <div class="card-footer">
                <button class='btn btn-primary' type='submit'
                    name='<?=(isset($_GET['post_id']) ? 'edit-post' : 'create-post')?>'>Create Post</button>
            </div>
        </div> <!-- end card -->
    </div><!-- end col-->
</div> <!-- end row-->
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
        ...
        placeholder: 'Welcome to Xnova Editor   !',
