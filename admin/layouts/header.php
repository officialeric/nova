...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | Xnova</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="A fully responsive admin theme which can be used to build CRM, CMS,ERP etc." name="description" />
    <meta content="Xnova" name="author" />
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown"
                            href="index.php#" role="button" aria-haspopup="false" aria-expanded="false">
                            <span class="account-user-avatar">
                                <img src="../process/uploads/<?=$user_data['profile_img']?>" alt="user-image" width="32"
